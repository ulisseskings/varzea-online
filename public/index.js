...
function applyAnchors() {
  document.querySelectorAll("[data-anchor]").forEach(el=>{
    ...
    if(
      el.classList.contains("cardred") ||
      (el.classList.contains("piece") && el.dataset.anchor?.startsWith("red"))
    ){
...
document.addEventListener("drop", (e) => {
  ...
  // ✅ atualiza localmente o anchor antes de esperar o servidor
  ...
  // ✅ reposiciona visualmente a peça pelo anchor
  applyAnchors();

  // ✅ agora sim testa se está sobre slot-pile
  updateExpulsionTokenScale();
